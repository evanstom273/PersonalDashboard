	...
	return (
		<DialogPortal>
			...
			<DialogPrimitive.Content
				className={cn(
					'fixed top-1/2 left-1/2 z-50 w-[min(24rem,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 rounded-xl border border-border bg-popover p-6 text-popover-foreground shadow-lg',
					className,
				)}
				{...props}
			>
