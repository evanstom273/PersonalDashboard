	...
	return (
		<SheetPortal>
			...
			<DialogPrimitive.Content
				className={cn(
					'fixed z-50 flex h-full flex-col bg-sidebar text-sidebar-foreground shadow-lg transition ease-in-out data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:animate-in data-[state=open]:duration-300',
					side === 'left'
