...
export function buildSystemInstruction(preferences: UserPreferences): string {
	...
	const sections = [
		...
		[
			...
			'- Image, music, and video files are generated by separate models. The app routes natural requests automatically — including follow-ups like "what about music", "what about a matching video", "can you animate it", or "can you generate me an image".',
